...
public class Patient {
    ...
    public String toString() {
        return "Patient{" + "id=" + id + ", name=" + name + ", age=" + age + ", weight=" + weight + ", height=" + height + ", diseaseSymptoms=" + diseaseSymptoms + ", cellPhone=" + cellPhone + ", systemicDiseases=" + systemicDiseases + ", treatmentStartDate=" + treatmentStartDate + ", treatmentEndDate=" + treatmentEndDate + '}';
    }
