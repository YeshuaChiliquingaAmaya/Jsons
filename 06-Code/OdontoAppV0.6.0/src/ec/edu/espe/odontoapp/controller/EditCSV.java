...
public class EditCSV {
    public void EditCSV() throws IOException{
        ...
        System.out.print("Enter the Id number to edit (1-" + (rows.size() - 1) + "): ");
        ...
        if (isValidIndex(rowIndex, columnIndex, rows)) {
            ...
            System.out.print("Enter the Correct new value for the cell: ");
            ...
            System.out.println("Cell successfully edited in the CSV file.");
        } else {
