 ...
 */
public class FrmBeforeAppointment extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnGenrateAppointment = new javax.swing.JButton();
        jPanel2 = new javax.swing.JPanel();
        jButton1 = new javax.swing.JButton();
        jButton2 = new javax.swing.JButton();
        lblEditWarning = new javax.swing.JLabel();
        btnAppointmentPreviously = new javax.swing.JButton();
        ...
        btnGenrateAppointment.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGenrateAppointmentActionPerformed(evt);
            }
        });
        ...
        btnAppointmentPreviously.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAppointmentPreviouslyActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnGenrateAppointment)
                    ...
                    .addComponent(JScrollPanelPatientsTable, javax.swing.GroupLayout.DEFAULT_SIZE, 652, Short.MAX_VALUE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(btnGenrateAppointment, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnGenrateAppointmentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenrateAppointmentActionPerformed
        if(tblPatients.getSelectedRow() == -1){
            ...
            FrmAppointments frmApointment = new FrmAppointments(patient);
            frmApointment.setVisible(true);
        }
    }//GEN-LAST:event_btnGenrateAppointmentActionPerformed
    ...
    private void btnAppointmentPreviouslyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAppointmentPreviouslyActionPerformed
        if (tblPatients.getSelectedRow() == -1) {
            lblEditWarning.setText("Selecciona un paciente.");
            lblEditWarning.setForeground(Color.RED);
        } else {
            lblEditWarning.setVisible(false);
            Patient patient = patients.get(tblPatients.getSelectedRow());
            ArrayList<Appointment> appointments = patientController.getAppointmentsByPatientId(patient.getClinicalHistory().getId());

            StringBuilder sb = new StringBuilder();
            for (Appointment appointment : appointments) {
                sb.append("Fecha: ").append(appointment.getDate()).append("\n");
                sb.append("Hora: ").append(appointment.getHour()).append("\n");
                sb.append("Servicio: ").append(appointment.getService()).append("\n");
                sb.append("=============================================\n");
            }

            JOptionPane.showMessageDialog(this, sb.toString(), "Citas del Paciente: " + patient.getClinicalHistory().getName(), JOptionPane.INFORMATION_MESSAGE);
        }
    
    }//GEN-LAST:event_btnAppointmentPreviouslyActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBeforeAppointment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBeforeAppointment().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton btnAppointmentPreviously;
    private javax.swing.JButton btnGenrateAppointment;
