...
public class generateBill {
    ...
    System.out.println("0. Finalizar y generar factura");
    ...
    double total = 0;
     ...
     while (true) {
        System.out.print("Ingrese el número del servicio seleccionado (0 para finalizar): ");
        ...
        total += precio;
        System.out.println("Servicio seleccionado: " + option);
