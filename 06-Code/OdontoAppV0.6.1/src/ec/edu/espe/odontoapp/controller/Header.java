...
public class Header {
    public void Header(){
        ...
        String header = "Id,Nombre,Edad,Peso,Altura,Síntomas de enfermedad,Numero de celular,Enfermedades Sistémicas,Fecha de inicio del tratamiento,Fecha de finalización del tratamiento";
