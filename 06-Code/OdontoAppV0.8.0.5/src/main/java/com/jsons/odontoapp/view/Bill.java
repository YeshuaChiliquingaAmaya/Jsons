...
public class Bill extends javax.swing.JFrame {
    ...
    public void setServicesModel(Patient patient){
        String[] header = {"Servicio", "Costo"};
        services.setColumnIdentifiers(header);
        tblServices.setModel(services);
        
        Object data[] = new Object[tblServices.getColumnCount()];
        
        for(Service service: patient.getAcquiredServices()){
            data[0] = service.getType();
            data[1] = service.getValue();
            services.addRow(data);
        }
        
    }
    
    public void setTotalModel(Patient patient){
        String[] header = {"Total"};
    ...
    public Bill(Patient patient, boolean availableDiscount) {
        initComponents();
        Date date = new Date();
        lblDate.setText(String.valueOf(date.getDay()) + "/" + String.valueOf(date.getMonth()) + "/" + String.valueOf(date.getYear()));
        lblPatientName.setText(patient.getClinicalHistory().getName());
        setServicesModel(patient);
        setTotalModel(patient);
